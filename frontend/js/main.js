...
// Auth Check on page load with seamless direct access
async function checkAuth(requiresRole = null) {
    try {
        ...
        if (data.authenticated && data.user) {
            ...
            // Automatically establish demo session so direct links open instantly
            try {
                ...
                console.log("Auto-login note:", autoErr);
            }

            // Redirect to login if on protected page and auto-auth failed
