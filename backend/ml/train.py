...
STATION_CAPACITIES = {
    1: 1500,  # Central Terminal (Red Line)
    2: 1200,  # Tech Park (Red Line)
    3: 900,   # University Heights (Red Line)
    4: 1100,  # City Center (Blue Line)
    5: 800,   # Financial District (Blue Line)
    6: 1000,  # Harbor View (Blue Line)
    7: 850,   # West End (Green Line)
    8: 950,   # Metro Plaza (Green Line)
    9: 750,   # North Junction (Yellow Line)
    10: 1300  # Airport Hub (Yellow Line)
}
