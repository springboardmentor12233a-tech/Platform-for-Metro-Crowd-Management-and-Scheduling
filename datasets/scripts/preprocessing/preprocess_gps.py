...
DATASET_NAME = "gps"
RAW_PATH = RAW_DIR / "gps-status.csv"
OUT_FILE = "gps_preprocessed.csv"
...
def run() -> None:
    ...
    df = df.rename(
        columns={
            "id_station_id": "station_id",
            "station_names": "station_name",
            "dist_from_first_station_km": "distance_from_start_km",
            "metro_line": "line",
            "opened_year": "opening_date",
