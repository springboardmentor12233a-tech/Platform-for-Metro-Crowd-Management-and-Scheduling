...
# ── Paths ─────────────────────────────────────────────────────────────────────────────
# Resolve datasets/ root (two levels up from datasets/scripts/eda/)
try:
...
CHARTS        = DATASETS_ROOT / "charts"
REPORTS       = DATASETS_ROOT / "reports"

# Legacy alias — kept for internal helper functions that reference BASE
BASE = DATASETS_ROOT

for d in [CHARTS, REPORTS]: d.mkdir(parents=True, exist_ok=True)
