...
import Milestone4Panel from '../components/Milestone4Panel.jsx';
...
export default function Dashboard() {
  ...
  const [milestone4, setMilestone4] = useState(null);
    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="mx-auto max-w-7xl px-6 py-8">
        <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            <p className="text-sm font-bold uppercase tracking-wider text-cyan-700">Milestones 1 to 4</p>
            <h1 className="mt-2 text-4xl font-black text-slate-950">MetroFlow Operations Dashboard</h1>
            <p className="mt-2 text-slate-500">
              Crowd monitoring, train scheduling, AI demand forecasting, alerts, analytics, testing, deployment, and operational reporting using Delhi Metro passenger data.
            </p>
          </div>
          <button
        ...
        {!loading && summary && (
          <>
            ...
            <section className="mt-8">
              <Milestone4Panel report={milestone4} />
            </section>
